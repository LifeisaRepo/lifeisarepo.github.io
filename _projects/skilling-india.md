...
tags: ["UE 5", "Mixed Reality", "WebSockets"]
---
...
### Personal Notes
_The idea behind developing the WebSocket-based operator control was a direct response to a human problem: technology can be intimidating. By giving our team a way to "hold the user's hand" through a tablet, we turned a complex technical demo into an inclusive educational tool._